...
void setup() {
  ...
  WiFi.mode(WIFI_STA);
  Serial.println("Start Gate Node");
  ...
  // TODO: Replace this with your laser receiver input pin
}

void loop() {
  // TEMPORARY: replace button with actual laser break detection
  if (digitalRead(0) == LOW) {
    strcpy(packet.gate, "start");
